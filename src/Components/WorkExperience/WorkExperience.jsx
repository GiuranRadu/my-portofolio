        ...
        <div className={styles['work-experience-container']}>
            ...
            <div className={styles['work-card--item']}>
              <div className={styles['work-card--item--content']}>
                ...
                <ul className={styles['job-bullets']}>
                  ...
                  <li>
                    <strong>Technologies:</strong> AEM (Adobe Experience Manager), React, TypeScript, JavaScript, Firebase, Redux, Tailwind, MaterialUi, NodeJs, ExpressJs, MongoDB.
                  </li>
                </ul>
          ...
          <div className={styles['work-card']} ref={ref2}>
            <div className={styles['work-card--item']}>
              <div className={styles['work-card--item--content']}>
                <div className={styles['arrow-head']}></div>
                <h3><em>IT Trainer Assistant</em></h3>
                <hr />
                <h4 className={styles['employer-title']}>NewTech Academy</h4>
                <ul className={styles['job-bullets']}>
                  <li>
                    In my role as a <strong><em>Trainer Assistant</em></strong>, I was responsible for giving our students tasks, helping to solve them, and managing our GitHub repository.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Technologies:</strong> JavaScript, TypeScript, HTML, CSS, React, Node.js, MongoDB
                  </li>
                </ul>
          ...
          <div className={styles['work-card']} ref={ref3}>
            <div className={styles['work-card--item']}>
              <div className={styles['work-card--item--content']}>
                <div className={styles['arrow-head']}></div>
                <h3><em>Web Developer & Administrator</em></h3>
                <hr />
                <h4 className={styles['employer-title']}>Hunting Store</h4>
                <ul className={styles['job-bullets']}>
                  <li>
                    In my role as a <strong><em>PrestaShop Developer</em></strong>, I was responsible for both building new features and maintaining the platform to support business growth.
                  </li>
                  <li>
